...
(function () {
  ...
  V.filaments = function (m) {
    ...
    for (const f of st.filaments) {
      ftb.append(h('tr', null, h('td', null, filChip(f), f.builtin && h('span', { class: 'src' }, 'Bambu')), h('td', null, f.material), h('td', { class: 'num' }, f.density), h('td', { class: 'num' }, f.flow),
    ...
    m.append(h('div', { class: 'grid2' },
      h('div', { class: 'card' }, h('h3', null, 'Filaments'), h('div', { class: 'tw' }, h('table', null, h('thead', null, h('tr', null, h('th', null, 'Filament'), h('th', null, 'Material'), h('th', { class: 'num' }, 'ρ g/cm³'), h('th', { class: 'num' }, 'Flow'), h('th', { class: 'num' }, 'Correction'), h('th', { class: 'num' }, '$/kg'), h('th'))), ftb)), h('p', { class: 'hint' }, 'Correction = median of (measured ÷ sliced) over weighed parts using the filament. Shown estimates are slicer × correction.')),
