...
_LABELS = [
    ...
    (r"^POST items/\d+/weighins$", "weigh-in"), (r"^DELETE weighins/\d+$", "delete weigh-in"), (r"^DELETE items/\d+/weighins$", "clear weigh-ins"), (r"^PUT weighins/\d+$", "edit weigh-in"), (r"^POST items/\d+/move$", "move line"), (r"^POST robots/\d+/reorder$", "rearrange lines"),
